...
#define STRING_CONFIG_H_AUTHOR "(James Ward, CTC I3 Pro B)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // CTC i3 DIY: these PID settings were copied from the original firmware
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // ANET A8 settings (appear to work for CTC i3 DIY, may tune these further)
